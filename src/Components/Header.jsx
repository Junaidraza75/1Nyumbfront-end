...
<MDBContainer>
      ...
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="container-fluid">
          ...
          <a class="navbar-brand" id="logo" href="/">1Nyumba<span style={{ color: "red" }}>Drive</span></a>
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/search">Property for Sale</a></li>
                  <li><a class="dropdown-item" href="/search">Commercial Property for Sale</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/search">House to Rent</a></li>
                  <li><a class="dropdown-item" href="/search">Apartment / Flat to Rent</a></li>
                  <li><a class="dropdown-item" href="/search">Commercial Property to Rent</a></li>

                  <li><a class="dropdown-item" href="/search">Retirement Property to Rent</a></li>
                  <li><a class="dropdown-item" href="/search">Developments to Rent</a></li>
              ...
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="/search">Developments for Sale</a></li>
                  <li><a class="dropdown-item" href="/search">Developments to Rent</a></li>

                  <li>
                    <a class="dropdown-item" href="/search">Retirement Developments for Sale</a>
                  </li>

                  <li>
                    <a class="dropdown-item" href="/search">Retirement Developments to Rent</a>
                  </li>
