                    ...
                    <MDBRow>
                        <MDBCol md="12" lg="12">
                            <div id="containerForDesktop">
                                ...
                                <div>
                                    <div id="searchInput">
                                        <input style={{ backgroundColor: "white" }} placeholder="Search for a City, Suburb or Web Reference" type="text" id="typeText" class="form-control" onChange={e => this.setState({ title: e.target.value })} />
